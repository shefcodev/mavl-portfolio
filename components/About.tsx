      ...
      <main className="about">
        <div className="flex flex-col gap-5 sm:gap-7">
          ...
          <motion.div {...motionValues}>
            ...
            <p className="about-desc mb-2">With a powerful blend of administrative expertise, tech-savviness, and data-driven insight, I Reduced client operational costs by 30% and increased productivity by 40% for 7+ businesses in the past 5 years, eliminate inefficiencies, and unlock hidden opportunities. my mission is to help lean teams run like enterprise-grade machines.</p>
